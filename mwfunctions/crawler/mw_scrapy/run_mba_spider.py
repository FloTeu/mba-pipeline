...
from mwfunctions.pydantic.crawling_classes import CrawlingMBAProductRequest, CrawlingMBARequest



def main(spider, crawling_mba_request: CrawlingMBARequest, **kwargs):
...
if __name__ == '__main__':
    ...
    crawling_mba_request = CrawlingMBAProductRequest(marketplace="de", daily=True, number_products=1, top_n=60,
