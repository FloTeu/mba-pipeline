...
yes Y | gcloud compute instances stop crawler-mba-auto-daily --zone us-west1-b
    '''.format(get_new_shirts, is_daily_script, region_space, number_of_instances, stop_instance_by_itself, additional_crawl, number_products_total, instance_name, create_urls_for_general_crawl, general_start_crawler_script)
